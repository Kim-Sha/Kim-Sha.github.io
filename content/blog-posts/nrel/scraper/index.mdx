...
featured: nrel_scraper_banner.png
---

<p className="lead">
  How do I build an ETL pipeline for an automated web scraper? In this post, I
...
So, next week I'll revisit this topic and discuss how my ETL pipeline can be
