...
This personal website / blog is developed using Gatsby JS, and is hosted on GitHub Pages. View the live demo [here](https://kim-sha.github.io/), and track the project backlog on my [Kanban board](https://github.com/Kim-Sha/Kim-Sha.github.io/projects/1).

## 🚀 Quick start

1.  **Fork this repository.**

    While I haven't formalized this project into a gatsby starter, you're welcome to fork this repository to customize your own web application. Once you've made
    your own copy of this project in your GitHub account, you'll be the owner, and can clone it locally to develop on it as you please.
...
_This project is built on Gatsby, an open-source front-end framework powered by React._

Looking for some guidance on buidling your own static website? Full documentation for Gatsby lives [on the website](https://www.gatsbyjs.com/). Here are some places to start:

- **For most developers, Gatsby's own [in-depth tutorial for creating a site](https://www.gatsbyjs.com/tutorial/) is a must-read.** It starts with zero assumptions about your level of ability and walks through every step of the process.
...
-**You may want to check out their vibrant collection of [official and community-created starters](https://www.gatsbyjs.com/docs/gatsby-starters/).

## 💫 Credits

Many elements of this static website were inspired by the [Intro.](https://github.com/wkocjan/gatsby-theme-intro) Gatsby theme created and open-sourced by [Wojciech Kocjan](https://kocjan.net/) from [Weeby Studio](https://weeby.studio/).
